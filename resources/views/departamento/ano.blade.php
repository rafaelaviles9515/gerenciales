...
@section('title','Seleccion de año por Departamento')
...
@section('content')
        ...
        <div class="container-sm">
              <br>
                    <h1 align="center">Seleccion de años por Departamento</h1>
                ...
                <br>
                        ...
                        <div class="card-header">Seleccione año</div>
                          <div class="card-body">
                              ...
                              <br>
                              <div align="center">
                              <button type="submit" class="btn btn-success">Ver Reporte anual por Departamento</button>
